...
function SectionL({ id }) {
	return (
		<Section id={id} bg="bg-surface">
			...
			<Card className="mt-24 bg-background border border-border shadow-sm group">
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
					<div className="lg:col-span-7">
						...
						<p className="main-description mb-8">
							...
							defense of a Strategic Portfolio, evaluated by
							industry leaders and academic scholars.
						</p>
