...
const Box = ({ title, desc, icon }) => {
	return (
		<Card className="group bg-surface transition-all duration-500 hover:-translate-y-2 hover:shadow-[0px_24px_48px_rgba(43,52,55,0.06)] border border-border/50 relative overflow-hidden">
			...
			<span className="relative z-10 mb-8 block text-lg text-primary-800">
				{icon}
			</span>
			<Heading as="h4" className="relative z-10 mb-4">
				{title}
			</Heading>
