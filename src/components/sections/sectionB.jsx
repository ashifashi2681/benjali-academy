			...
			<div className="grid lg:grid-cols-12 gap-12 items-center">
				<div className="lg:col-span-5 space-y-6">
					...
					<div className="space-y-4 pt-4">
						<div className="flex items-start space-x-4">
							<div className="w-12 h-12 bg-surface rounded-xl shadow-sm flex items-center justify-center shrink-0">
								<span
				...
				<div className="lg:col-span-7 grid grid-cols-2 gap-4">
					<div className="space-y-4">
						...
						<div className="h-48 rounded-2xl overflow-hidden shadow-lg border border-border bg-primary-500 p-8 text-text-primary flex flex-col justify-end">
					...
					<div className="space-y-4 pt-12">
						<div className="h-48 rounded-2xl overflow-hidden shadow-lg border border-border bg-secondary-500 p-8 text-text-primary flex flex-col justify-end">
